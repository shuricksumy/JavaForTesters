...
public class GroupStepDefinition {
  ...
  public void createGroup(String name, String header, String footer) {
    newGroup = new GroupData().withName(name).withFooter(footer).withHeader(header);
    app.goTo().groupPage();
  ...
  public void verifyGroup() {
    ...
    MatcherAssert.assertThat(newGroups,
        CoreMatchers.equalTo(groups.withAdded(newGroup.withId(newGroups.stream().mapToInt((g) -> g.getId()).max().getAsInt()))));
  }
